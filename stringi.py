...
# sztuczka z wyszukiwaniem, np czegos w cudzyslowiu:
tekst = 'sialala "ahahaha" dadada'
temp = tekst[tekst.find('"')+1:]
...
print("costam {1:20s} a moze {0:d}".format(111, "sialala"))   # podobnie ale z uzyciem formatowania, fajne bo pozwala
